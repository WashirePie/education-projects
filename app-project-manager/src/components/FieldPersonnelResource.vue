<template>
  ...
  <div>
    ...
    <div class="form-group-body">
      <select v-model="employeeFunctionValue" class="form-select">
        <option v-for="func in employeeFunctions" :key="func.name" :value="func.name">{{ func.name }}</option>
      </select>
    </div>
  </div>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const employeeFunctions: ComputedRef<Array<IEmployeeFunction>> = computed(() =>
