    ...
    <div class="Box mt-2">
      ...
      >
        ...
        <span 
          ...
          :class="proj.isDenied ?           'bg-red text-white' 
                : proj.isExecuting ?        'bg-pink text-white' 
                : proj.isAwaitingApproval ? 'bg-yellow text-gray-dark' 
                : proj.isCancelled ?        'bg-red text-white'
