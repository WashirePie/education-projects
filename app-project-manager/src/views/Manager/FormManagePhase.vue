<template>
  ...
  <div v-if="phase.milestones.length">
    ...
    <div class="Box Box--condensed mt-2">
      ...
      >
        ...
        <span v-if="milestone.isEvaluated" class="IssueLabel bg-green text-white mr-2"
          >✔️ Evaluated ({{ milestone.state }})</span
        >
  ...
  <button class="btn mt-4" type="button" @click="phase.addDocuments()">
